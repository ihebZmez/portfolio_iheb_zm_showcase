  ...
  return (
    <div id="projectsSaaS" className="py-20">
      <h1 className="heading">
        ...
        <span className="text-purple">Projets SaaS</span>
      </h1>
        ...
        {projectsSaaS.map((item) => (
          ...
          >
            <PinContainer title={item.linkName} href={item.linkProject}>
              ...
              <p
                className="lg:text-sm lg:font-normal font-light text-sm line-clamp-5"
                style={{
                  color: "#BEC1DD",
                  margin: "1vh 0",
                }}
...
export default RecentProjectsSaaS;
